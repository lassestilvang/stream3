...
export const addWatchedItem = async (params: AddWatchedItemParams): Promise<WatchedItem> => {
...
export const getWatchedItems = async (userId: string): Promise<WatchedItem[]> => {
...
export const updateWatchedItem = async (id: string, updates: Partial<WatchedItem>): Promise<void> => {
  await db
...
export const addToWatchlist = async (params: AddWatchlistItemParams): Promise<WatchlistItem> => {
  const [result] = await db
    .insert(watchlist)
    .values({
      id: uuidv4(),
...
export const addToWatchedFromWatchlist = async (watchlistId: string): Promise<void> => {
